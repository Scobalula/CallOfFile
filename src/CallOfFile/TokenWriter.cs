...
{
    /// <summary>
    /// A class that defines methods to handle writing tokens to Call of Duty *_EXPORT/*_BIN files.
    /// </summary>
    public abstract class TokenWriter : IDisposable
    {
        ...
        public virtual void WriteToken(TokenData data)
        {
            switch (data.Token.DataType)
            {
                case TokenDataType.Comment:
                    {
                        var castedData = (TokenDataComment)data;
                        WriteComment(
                            data.Token.Name,
                            data.Token.Hash,
                            castedData.Comment);
                ...
                case TokenDataType.Tri:
                    {
                        ...
                        WriteTri(
                            data.Token.Name,
                            data.Token.Hash,
                            castedData.ObjectIndex,
                            castedData.MaterialIndex);
                        break;
                    }
        ...
        /// <summary>
        /// Handles disposing of the <see cref="TokenWriter"/> and finalizes its reading.
        /// </summary>
        ...
        /// <summary>
        /// Creates a matching <see cref="TokenWriter"/> for the provided file.
        /// </summary>
        ...
        public static TokenWriter CreateWriter(string fileName)
        {
            ...
            {
                return new BinaryTokenWriter(fileName);
            }
            ...
            {
                return new ExportTokenWriter(fileName);
            }
